...
The "rapid explanation" of the starter code is in a powerpoint file which we will go through in the session. You can download this file for yourself by going to [this link](build_snowflakes.pptx) and clicking on the button in the top right of the page called *Download raw file*. This will give you the option to save the file on your computer.
