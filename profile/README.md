...
There is a starter project for **Broadcasting** and you can find it [here](https://scratch.mit.edu/projects/1286070474/). We have made a powerpoint presentation which you can work through by yourself, and the link is here: [Broadcasting in Scratch.pptx](https://1drv.ms/p/c/0ea54730735a1344/IQDgI8NWVgxNRLavszyTdvnTAWVjhWu40CdgVJeSuyBEBFg?e=ifXwPZ). (Note: if there are any problems opening this file try the alternative link [here](https://docs.google.com/presentation/d/1qWmqWVJMwl_E6KnMFq4Raca8rOwy8O3_/edit?usp=sharing&ouid=116750909637562215455&rtpof=true&sd=true). The best thing is to *right-click* on this link and choose *Save File As* and download it to your computer.)
