...
When we ran this project before we found there was a useful website for removing the background from internet images of things which you might want to sell in your shop. The website is [https://www.erase.bg/](https://www.erase.bg/).
